...
[**Live → bakar-dev.github.io**](https://bakar-dev.github.io)
...
- **Project command center** — real case studies (Intelligize+ AI, Delivery Delight,
  PepsiCo · MountainTop, Visalay, Yellow School) with architecture, decisions,
...
<div align="center">
<sub>Designed & built by Muhib.</sub>
</div>
